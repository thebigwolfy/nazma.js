...
class Giveaway extends EventEmitter {
    ...
    get messageURL() {
        ...
        return String("https://discord.com/channels/" + this.guildID + "/" + this.channelID + "/" + this.messageID);
    ...
    async fetchMessage() {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if(!message) {
                ...
                return reject("NazmaJS - Giveaway - Unable to fetch message with ID: " + this.messageID);
    ...
    edit(options = {}) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if(winners.length > 0) {
                ...
                let embed = this.manager.generateNoValidParticipantsEndEmbed(this);
